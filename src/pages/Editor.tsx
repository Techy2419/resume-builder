...
import { ATSScanner } from '../components/ats-scanner/ATSScanner';
import { ImportResumeModal } from '../components/modals/ImportResumeModal';
import { TemplateSelectionModal } from '../components/modals/TemplateSelectionModal';
import { Button } from '../components/ui/Button';
import { Download, Settings as SettingsIcon, FileUp, Layout, Scan } from 'lucide-react';
import { exportToPDF } from '../utils/pdfExport';

export const Editor: React.FC = () => {
  const navigate = useNavigate();
  const { resume } = useResumeStore();
  const [activeTab, setActiveTab] = useState<'content' | 'style' | 'ats'>('content');
  ...
  const tabs = [
    ...
    { id: 'style', label: 'Style', icon: SettingsIcon },
  ...
  const renderEditor = () => {
    ...
    switch (activeSection) {
      ...
      case 'certifications':
        return <div className="p-8 text-gray-500">Certifications editor coming soon...</div>;
      default:
